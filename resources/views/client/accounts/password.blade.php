    ...
    <main>
        ...
        <div class="container mt-4">
            ...
            <nav class="nav nav-borders">
                <a class="nav-link" href="{{ route('client.accounts.profile', auth()->user()->id) }}">Profile</a>
                <a class="nav-link active ml-0" href="#">Password</a>
            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('client.accounts.passwordUpdate', Auth::user()->id) }}" method="POST">
                                @csrf
                                <!-- Form Group (username)-->
