...
Route::get('/companies/{company}/delete', 'CompanyController@destroy')->name('companies.destroy');
...
Route::get('/paymethods/{paymethod}/delete', 'PaymethodController@destroy')->name('paymethod.destroy');
